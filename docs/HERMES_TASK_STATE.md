...
Current item: W7 (VERIFIED)
Status: IN_PROGRESS (W8 — после подтверждения)

Last completed items: W7 — update/remove/pause/resume + script-jobs в CronService за флагом
Last commits: 86e2e87 (W6), W7 (этот коммит)
